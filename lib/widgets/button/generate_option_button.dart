...
class GenerateOptionButton extends StatefulWidget {
  ...
  @override
  State<GenerateOptionButton> createState() => _GenerateOptionButtonState();
}

class _GenerateOptionButtonState extends State<GenerateOptionButton>
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isGenerating) {
      ...
      labelText = AppLocalizations.of(context)!.regenerateoptions;
    } else {
      labelText = AppLocalizations.of(context)!.generateoptions;
    }
