...
class _SuggestedUsersListState extends State<SuggestedUsersList>
  ...
  Widget build(BuildContext context) {
    ...
    if (_isError && _users.isEmpty) {
      bodyWidget = ApiErrorWidget(onRetry: () => _fetchPage(1, isRefresh: true));
                        ...
                        return StatefulBuilder(
                          builder: (context, setLocalState) {
                            ...
                            final double cardPadding =
                                (itemHeight * 0.08).clamp(8.0, 20.0);
                            final double avatarRadius =
                                (itemHeight * 0.18).clamp(24.0, 45.0);
                            final double nameFontSize =
                                (itemHeight * 0.06).clamp(11.0, 14.0);
                            final double mutualFontSize =
                                (itemHeight * 0.05).clamp(10.0, 12.0);
                            final double buttonFontSize =
                                (itemHeight * 0.048).clamp(9.0, 11.0);

                            final double spacing1 =
                                (itemHeight * 0.035).clamp(4.0, 8.0);
                            final double spacing2 =
                                (itemHeight * 0.022).clamp(2.0, 5.0);
                            final double buttonTopMargin =
                                (itemHeight * 0.05).clamp(4.0, 12.0);
                            final double buttonHeight =
                                (itemHeight * 0.14).clamp(26.0, 32.0);
                                ...
                                children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          SizedBox(
                                            ...
                                            width: (user.mutualFriendsAvatars
                                                            .take(3)
                                                            .length -
                                                        1) *
                                                    mutualOverlapShift +
                                  ...
                                  GestureDetector(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      margin:
                                          EdgeInsets.only(top: buttonTopMargin),
                                      height: buttonHeight,
