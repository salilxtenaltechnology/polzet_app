...
class HashtagsImagePollRanking extends StatefulWidget {
  ...
  final HashtagPollModel poll;

  const HashtagsImagePollRanking({
    super.key,
    required this.post,
    required this.poll,
  });
  ...
  @override
  State<HashtagsImagePollRanking> createState() =>
      _HashtagsImagePollRankingState();
}

class _HashtagsImagePollRankingState extends State<HashtagsImagePollRanking> {
  late List<HashtagPollOption> _orderedImages;
  ...
  void initState() {
    ...
    final profileImage = widget.post.user.profileImage ?? '';
...
class _HashtagRankImageCard extends StatelessWidget {
  final HashtagPollOption option;
  final int? rank;
  final List<HashtagPollOption> allImages;
  final int index;
  final String Function(String) resolveUrl;

  const _HashtagRankImageCard({
    super.key,
