...
class UserImageRanking extends StatefulWidget {
  ...
  @override
  State<UserImageRanking> createState() => _UserImageRankState();
}

class _UserImageRankState extends State<UserImageRanking> {
