...
class QuestionPollScreen extends StatefulWidget {
  const QuestionPollScreen({super.key});

  @override
  State<QuestionPollScreen> createState() => _QuestionPollScreenState();
}

class _QuestionPollScreenState extends State<QuestionPollScreen> {
  // ── Constants ─────────────────────────────────────────────────────────────
  ...
  void _clearOptionsError() {
    if (_optionsError.isNotEmpty &&
        _getValidOptions().length >= _minOptions) {
